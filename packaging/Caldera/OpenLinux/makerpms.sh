...
if [ $devel -ne 0 ]; then
        ( cd ../../../.. ; chown -R ${USERID}.${GRPID} samba; mv samba samba-2.2.12 )
        ( cd ../../../.. ; tar czvf ${SRCDIR}/samba-2.2.12.tar.gz samba-2.2.12; mv samba-2.2.12 samba )
else
        ( cd ../../../.. ; chown -R ${USERID}.${GRPID} samba-2.2.12 )
        ( cd ../../../.. ; tar czvf ${SRCDIR}/samba-2.2.12.tar.gz samba-2.2.12 )
fi
