		  ...
		  int dum_buffsize)
{
  ...
  DEBUG(3,("joph inbuf=%s outbuf=%s p=%s\n",inbuf,outbuf,p));
  ...
  case ARCH_SAMBA:
	...
	DEBUG(3,("joph ARCH_SAMBA\n"));
    break;
  case ARCH_WFWG:
    set_remote_arch(RA_WFWG);
	DEBUG(3,("joph RA_WFWG\n"));
    break;
  case ARCH_WIN95:
    set_remote_arch(RA_WIN95);
	DEBUG(3,("joph RA_WIN95\n"));
    break;
  case ARCH_WINNT:
   if(SVAL(inbuf,smb_flg2)==FLAGS2_WIN2K_SIGNATURE) {
     set_remote_arch(RA_WIN2K);
	 DEBUG(3,("joph RA_WIN2K\n"));
   }else{
     set_remote_arch(RA_WINNT);
	 DEBUG(3,("joph RA_WINNT\n"));
   	}
    break;
  case ARCH_WIN2K:
    set_remote_arch(RA_WIN2K);
